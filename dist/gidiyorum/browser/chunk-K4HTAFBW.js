...
var RegisterComponent = class _RegisterComponent {
  ...
  onRegister(event) {
    return __async(this, null, function* () {
      ...
      try {
        yield this.authService.signUp(this.email, this.password, this.fullName);
      } catch (e) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RegisterComponent, selectors: [["app-register"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 59, vars: 19, consts: [[1, "min-h-screen", "bg-background", "flex", "flex-col", "justify-center", "items-center", "px-4", "py-8"], [1, "w-full", "max-w-md", "space-y-8", "bg-white", "p-8", "sm:p-10", "rounded-3xl", "border", "border-black/[0.06]", "shadow-luxe"], [1, "text-center", "space-y-2"], [1, "w-14", "h-14", "rounded-2xl", "bg-obsidian", "text-white", "flex", "items-center", "justify-center", "mx-auto", "shadow-sm"], ["strokeWidth", "1.5", 1, "text-white", 3, "img", "size"], [1, "text-2xl", "font-serif-luxe", "font-normal", "text-stone-950", "tracking-tight"], [1, "text-xs", "text-stone-400"], [1, "p-3.5", "bg-red-50/80", "border", "border-red-100", "text-red-600", "rounded-2xl", "text-xs", "font-semibold", "flex", "items-center", "gap-2"], [1, "space-y-4", 3, "submit"], [1, "block", "text-xs", "font-bold", "text-stone-700", "mb-1.5", "uppercase", "tracking-wider"], [1, "relative"], [1, "absolute", "left-3.5", "top-3.5", "text-stone-400"], ["strokeWidth", "1.5", 3, "img", "size"], ["name", "fullName", "type", "text", "required", "", "placeholder", "Emre Y\u0131lmaz", 1, "w-full", "pl-11", "pr-4", "py-3", "rounded-2xl", "border", "border-black/[0.06]", "text-xs", "sm:text-sm", "focus:outline-none", "focus:ring-1", "focus:ring-obsidian/30", "focus:border-obsidian", "bg-white", "transition-all", "shadow-subtle", 3, "ngModelChange", "ngModel"], ["name", "email", "type", "email", "required", "", "placeholder", "ornek@gidiyorum.app", 1, "w-full", "pl-11", "pr-4", "py-3", "rounded-2xl", "border", "border-black/[0.06]", "text-xs", "sm:text-sm", "focus:outline-none", "focus:ring-1", "focus:ring-obsidian/30", "focus:border-obsidian", "bg-white", "transition-all", "shadow-subtle", 3, "ngModelChange", "ngModel"], ["name", "password", "required", "", "placeholder", "En az 6 karakter", 1, "w-full", "pl-11", "pr-11", "py-3", "rounded-2xl", "border", "border-black/[0.06]", "text-xs", "sm:text-sm", "focus:outline-none", "focus:ring-1", "focus:ring-obsidian/30", "focus:border-obsidian", "bg-white", "transition-all", "shadow-subtle", 3, "ngModelChange", "ngModel", "type"], ["type", "button", "title", "\u015Eifreyi g\xF6ster/gizle", 1, "absolute", "right-3.5", "top-3.5", "text-stone-400", "hover:text-stone-700", "transition-colors", 3, "click"], [1, "pt-2"], ["type", "submit", "label", "Kay\u0131t Ol", "size", "lg", 3, "fullWidth", "loading"], [1, "absolute", "inset-0", "flex", "items-center"], [1, "w-full", "border-t", "border-black/[0.05]"], [1, "relative", "flex", "justify-center"], [1, "bg-white", "px-3", "text-[11px]", "text-stone-400", "font-medium"], [1, "space-y-2.5"], ["type", "button", 1, "w-full", "flex", "items-center", "justify-center", "gap-3", "bg-white", "border", "border-black/[0.08]", "rounded-2xl", "px-4", "py-3", "text-xs", "font-bold", "text-stone-800", "hover:bg-stone-50", "transition-colors", "shadow-subtle", "disabled:opacity-50", 3, "click", "disabled"], ["viewBox", "0 0 24 24", 1, "w-4", "h-4"], ["fill", "#4285F4", "d", "M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"], ["fill", "#34A853", "d", "M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"], ["fill", "#FBBC05", "d", "M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"], ["fill", "#EA4335", "d", "M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"], ["type", "button", 1, "w-full", "flex", "items-center", "justify-center", "gap-3", "bg-white", "border", "border-black/[0.08]", "rounded-2xl", "px-4", "py-3", "text-xs", "font-bold", "text-stone-950", "hover:bg-stone-50", "transition-colors", "shadow-subtle", "disabled:opacity-50", 3, "click", "disabled"], ["viewBox", "0 0 24 24", 1, "w-4", "h-4", "fill-current"], ["d", "M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 6.32c.67-.82 1.13-1.96.99-3.11-1 .04-2.18.67-2.88 1.49-.62.72-1.16 1.88-1.01 3.01 1.11.09 2.22-.57 2.9-1.39z"], [1, "text-center", "pt-2"], [1, "text-xs", "text-stone-500"], ["routerLink", "/auth/login", 1, "font-bold", "text-obsidian", "hover:underline", "ml-1"]], template: function RegisterComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(20, "E-posta Adresi");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(21, "div", 10)(22, "span", 11);
        \u0275\u0275element(23, "lucide-icon", 12);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275element(33, "lucide-icon", 12);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(34, "div", 17);
        \u0275\u0275element(35, "app-ui-button", 18);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(36, "div", 10)(37, "div", 19);
        \u0275\u0275element(38, "div", 20);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(39, "div", 21)(40, "span", 22);
        \u0275\u0275text(41, "veya sosyal hesab\u0131n\u0131zla");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(42, "div", 23)(43, "button", 24);
        \u0275\u0275listener("click", function RegisterComponent_Template_button_click_43_listener() {
          return ctx.signInWithGoogle();
        });
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(44, "svg", 25);
        \u0275\u0275element(45, "path", 26)(46, "path", 27)(47, "path", 28)(48, "path", 29);
        \u0275\u0275elementEnd();
        \u0275\u0275text(49, " Google ile Devam Et ");
        \u0275\u0275elementEnd();
        \u0275\u0275namespaceHTML();
        ...
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(51, "svg", 31);
        \u0275\u0275element(52, "path", 32);
        \u0275\u0275elementEnd();
        \u0275\u0275text(53, " Apple ile Devam Et ");
        \u0275\u0275elementEnd()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(54, "div", 33)(55, "p", 34);
        \u0275\u0275text(56, " Zaten hesab\u0131n\u0131z var m\u0131? ");
        \u0275\u0275elementStart(57, "a", 35);
        \u0275\u0275text(58, "Giri\u015F Yap\u0131n");
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(4);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RegisterComponent, { className: "RegisterComponent", filePath: "src\\app\\features\\auth\\register.component.ts", lineNumber: 153 });
})();
export {
  RegisterComponent
};
//# sourceMappingURL=chunk-K4HTAFBW.js.map
